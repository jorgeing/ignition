class ProcesadorTagsDeAntena:
	"""Orquesta la lectura de tags de una antena RFID y escribe el resultado procesado en el tag de destino."""
	...
	def __init__(self, nombre_antena, path_json_lectura_antena, path_objeto_destino, tag_utiliza_string_plano = False):
		"""Inicializa el procesador cargando los datos actuales del tag y creando el procesador de antena."""
	...
	def procesaYEscribeEnDestino(self):
		"""Procesa los datos de la antena y escribe el resultado en el tag de destino."""
